...
CREATE TABLE LOCAL_BANK_SUPPORT_DTL (LBS_DTL_ID VARCHAR PRIMARY KEY, LBS_ID VARCHAR, SUPPORT_LIMIT NUMBER(10), RATE_MIN NUMBER(3,2), RATE_AVG NUMBER(3,2), RATE_MAX NUMBER(3,2));
