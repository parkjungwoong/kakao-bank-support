...
CREATE TABLE LOCAL_BANK_SUPPORT (LBS_ID VARCHAR PRIMARY KEY, REGION_ID VARCHAR, TARGET VARCHAR, SUPPORT_LIMIT NUMBER(12), RATE_MIN NUMBER(5,2), RATE_AVG NUMBER(5,2), RATE_MAX NUMBER(5,2), INSTITUTE VARCHAR, MGMT VARCHAR, RECEPTION VARCHAR, INST_ID VARCHAR, INST_DTM DATETIME, UPDT_ID VARCHAR, UPDT_DTM DATETIME);

-- 용도 코드 테이블
DROP TABLE IF EXISTS USAGE_CODE;
CREATE TABLE USAGE_CODE (USAGE_CODE_ID VARCHAR PRIMARY KEY, USAGE VARCHAR, USE_YN VARCHAR);
...
CREATE TABLE REGION_MAS (REGION_ID VARCHAR PRIMARY KEY, REGION_NM VARCHAR, MAP_ID VARCHAR);
...
CREATE TABLE USER_INFO (USER_NO VARCHAR PRIMARY KEY, USER_ID VARCHAR NOT NULL , USER_PW VARCHAR NOT NULL , INST_ID VARCHAR NOT NULL, INST_DTM DATETIME, UPDT_ID VARCHAR, UPDT_DTM DATETIME, USE_YN VARCHAR NOT NULL );
