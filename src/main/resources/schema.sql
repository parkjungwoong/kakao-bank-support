...
CREATE TABLE LOCAL_BANK_SUPPORT_DTL (LBS_DTL_ID VARCHAR PRIMARY KEY, LBS_ID VARCHAR, USAGE_OPT_ID VARCHAR, SUPPORT_LIMIT_MIN NUMBER(10), SUPPORT_LIMIT_AVG NUMBER(10), SUPPORT_LIMIT_MAX NUMBER(10), RATE_MIN NUMBER(3,2), RATE_AVG NUMBER(3,2), RATE_MAX NUMBER(3,2));
...
CREATE TABLE USAGE_OPT (USAGE_OPT_ID VARCHAR PRIMARY KEY, USAGE_CODE_ID VARCHAR, LBS_ID VARCHAR, USE_YN VARCHAR);
